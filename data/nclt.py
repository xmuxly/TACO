...
from data.robotcar_sdk.python.velodyne import load_velodyne_binary_seg, load_velodyne_binary_seg_feature96, load_velodyne_binary_seg_feature36
    ...
    def __init__(self, data_path, split='train', real=False,):
        ...
        for seq in seqs:
            ...
            if not os.path.isfile(h5_path):
                ...
                ts_raw = []
                # 读入LiDAR时间戳，并从小到大排序
                vel = os.listdir(seq_dir + '/sphere_velodyne_left_feature32')
